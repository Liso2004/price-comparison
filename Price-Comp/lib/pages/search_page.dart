            ...
            style: const TextStyle(
              ...
              Expanded(
                child: _loading
                    ...
                    : _results.isEmpty
? Expanded( 
    child: SingleChildScrollView( // Add scrolling for safety
      child: Column(
        children: [
          ...
          if (_ctrl.text.isNotEmpty && !_loading)
            Align(
              alignment: Alignment.centerLeft,
              child: Padding(
                padding: const EdgeInsets.only(left: 0, bottom: 12.0),
                child: Text(
                  'Showing results for "${_ctrl.text}"',
                  style: const TextStyle(
                    fontFamily: 'Inter',
          ...
          Container(
            ...
            constraints: BoxConstraints( // Add constraints instead of fixed height
              minHeight: 230,
            ...
            child: Column(
              ...
              mainAxisSize: MainAxisSize.min, // Important: use min here
              children: [
                const Text(
                  'No results found',
                  style: TextStyle(
                ...
                OutlinedButton(
                  style: OutlinedButton.styleFrom(
                    ...
                    side: const BorderSide(color: _lightTextColor),
                    backgroundColor: Colors.white,
